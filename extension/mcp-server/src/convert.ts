...
async function scanAgentsInDir(
  dir: string,
  level: 'global' | 'project',
...
export async function discoverAgents(
  ...
  if (projectDir) {
    const projectAgents = await scanAgentsInDir(
...
export function personaOutputPath(agent: AgentDefinition): string {
...
export function buildConversionPrompt(agent: AgentDefinition): string {
